...
- [x] O usuário não pode realizar mais de um check-in na mesma academia no mesmo dia;
- [x] O usuário não pode realizar check-in caso não esteja a, no máximo, 100 metros da academia;
